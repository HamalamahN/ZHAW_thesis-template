...
\supervisor{Michael \textsc{Wüthrich}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\author{Nicoló \textsc{Tropeano}} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
\addresses{} % Your address, this is not currently used anywhere in the template, print it elsewhere with \addressname

\subject{Additive Manufacturing} % Your subject area, this is not currently used anywhere in the template, print it elsewhere with \subjectname
...
\department{\href{https://www.zhaw.ch/en/lsfm/institutes-centres/ims/}{Institute for Mechatronic Systems}} % Your department's name and URL, this is used in the title page and abstract, print it elsewhere with \deptname
\group{\href{https://www.zhaw.ch/en/lsfm/institutes-centres/ias/research-development/computational-genomics/}{Additive Manufacturing}} % Your research group's name and URL, this is used in the title page, print it elsewhere with \groupname
